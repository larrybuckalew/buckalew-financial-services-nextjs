...
export default function WholeLifeConsultation() {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold text-primary mb-6">
            Schedule Your Whole Life Insurance Consultation
          </h1>
          
          <p className="text-gray-600 mb-8">
            Discuss whole life insurance options with our expert advisors. We'll help you 
            understand the benefits of permanent coverage and cash value accumulation.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-gray-700 mb-2" htmlFor="financialGoals">
                ...
                >
                  ...
                  <option value="savings">Cash Value Accumulation</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Any specific questions about whole life insurance or cash value benefits?"
                ></textarea>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500 mt-4">
              By submitting this form, you agree to be contacted about whole life insurance 
